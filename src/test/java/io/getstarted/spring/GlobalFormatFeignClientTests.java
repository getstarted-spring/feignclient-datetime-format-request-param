...
@SpringBootTest(
    classes = GlobalFormatFeignClientTests.FeignConfiguration.class,
    webEnvironment = WebEnvironment.RANDOM_PORT)
@Import(DateFormatConfiguration.class)
class GlobalFormatFeignClientTests {
  ...
  @RibbonClient(
      name = "default",
      configuration = GlobalFormatFeignClientTests.RibbonConfiguration.class)
