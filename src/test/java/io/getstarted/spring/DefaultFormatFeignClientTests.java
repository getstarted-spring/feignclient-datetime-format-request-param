...
@SpringBootTest(
    classes = DefaultFormatFeignClientTests.FeignConfiguration.class,
    webEnvironment = WebEnvironment.RANDOM_PORT)
class DefaultFormatFeignClientTests {

  @Autowired DefaultFormatFeignClient feignClient;

  @Test
  public void localDate() {
    final LocalDate date = LocalDate.parse("2019-12-31");
    assertThat(this.feignClient.localDate(date))
  ...
  public void localTime() {
    ...
    assertThat(this.feignClient.localTime(time))
  ...
  public void localDateTime() {
    ...
    assertThat(this.feignClient.localDateTime(dateTime))
        .isEqualTo(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.SHORT).format(dateTime));
  }

  @EnableFeignClients(clients = DefaultFormatFeignClient.class)
  @RestController
  ...
  @RibbonClient(
      name = "default",
      configuration = DefaultFormatFeignClientTests.RibbonConfiguration.class)
